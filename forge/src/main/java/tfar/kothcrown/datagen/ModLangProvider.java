...
public class ModLangProvider extends LanguageProvider {
    public ModLangProvider(PackOutput output) {
        super(output, KothCrown.MOD_ID, "en_us");
    }

    @Override
    protected void addTranslations() {
        //addTranslatableComponent(ModCreativeTabs.TITLE,"KOTHCrown");
        addDefaultBlock(() -> Init.KING_OF_THE_HILL);
        addDefaultItem(() -> Init.CROWN);
    }
