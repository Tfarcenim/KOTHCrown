...
import tfar.kothcrown.network.PacketHandler;
...
public class KothCrown {

    public static final String MOD_ID = "kothcrown";
    public static final String MOD_NAME = "KothCrown";
